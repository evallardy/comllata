...
urlpatterns = [
    ...
    path('recomendacion/', RecomendacionListView.as_view(), name='recomendacion_list'),
    path('recomendacion/nuevo/', RecomendacionCreateView.as_view(), name='recomendacion_create'),
    path('recomendacion/editar/<int:pk>/', RecomendacionUpdateView.as_view(), name='recomendacion_update'),
    path('recomendacion/eliminar/<int:pk>/', RecomendacionDeleteView.as_view(), name='recomendacion_delete'),
    path('carrito/', Carrito.as_view(), name='carrito'),
    path('formaPago/', FormaPago.as_view(), name='formaPago'),
