...
urlpatterns = [
    ...
    path('consulta/nuevo/', ConsultaCreateView.as_view(), name='consulta_create'),
    path('consulta/editar/<int:pk>/', ConsultaUpdateView.as_view(), name='consulta_update'),
    path('consulta/eliminar/<int:pk>/', ConsultaDeleteView.as_view(), name='consulta_delete'),
    path('carrito/', Carrito.as_view(), name='carrito'),
    path('formaPago/', FormaPago.as_view(), name='formaPago'),
    path('about/', About.as_view(), name='about'),
    path('contact/', Contact.as_view(), name='contact'),
    path('contact/gracias/', ContactGracias.as_view(), name='contact_gracias'),
