...
class ActualizarLlantasView(TemplateView):
    template_name = "core/total_actualizados.html"
...
class BuscarLlantaView(TemplateView):
    template_name = "core/buscar_llanta.html"
...
#                    print ('comentario : ' + dato)
        ...
        return render(request, self.template_name, {'opcion_seleccionada': opcion_seleccionada, 'busqueda_llantas': busqueda_llantas, 'presenta': presenta})
